...
public class WishlistServiceImpl implements WishlistService {
    ...
    public WishlistDTO addToWishlist(Long bookId, String notes) throws Exception {
        ...
        String planCode = subscription != null && subscription.getPlanCode() != null
    ...
    public pageResponse<WishlistDTO> getMyWishlist(int page, int size) throws Exception {
        ...
        return getWishlists(userId, page, size);
    }

    @Override
    public pageResponse<WishlistDTO> getWishlists(Long userId, int page, int size) throws Exception {
        Pageable pageable = PageRequest.of(page, size, Sort.by("addedAt").descending());
        Page<Wishlist> wishlistPage = userId == null
                ? wishlistRepository.findAll(pageable)
